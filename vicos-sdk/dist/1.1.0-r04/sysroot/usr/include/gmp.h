...
#define __GMP_CC "arm-oe-linux-gnueabi-gcc  -march=armv7-a -mfloat-abi=softfp -mfpu=neon "
#define __GMP_CFLAGS "-marm -O2 -pedantic -fomit-frame-pointer  -O2 -fexpensive-optimizations -frename-registers -fomit-frame-pointer -ftree-vectorize   -Wno-error=maybe-uninitialized -finline-functions -finline-limit=64  -fstack-protector-all -D_FORTIFY_SOURCE=2"
