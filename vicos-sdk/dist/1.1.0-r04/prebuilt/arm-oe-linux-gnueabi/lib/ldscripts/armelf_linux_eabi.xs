...
OUTPUT_ARCH(arm)
ENTRY(_start)
SEARCH_DIR("/Users/kerigan/Downloads/build-tools/build-scripts/build-victor-toolchain/vicos-sdk-1.1.0-r05-aarch64-apple-darwin/prebuilt/arm-oe-linux-gnueabi/lib");
SECTIONS
{
